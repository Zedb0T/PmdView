        ...
        public void ExtractisotofolderPLY(string pfPath)
        {
            ...
            for (var i = 1; i <= 25; i++)
            {
                ...
                if (Directory.Exists(isoPath + "\\" + stagePath))
                {
                    ...
                    if (pf is not null)
                    {
                        ...
                        if (pf.files.Count != 0)
                        {
                            ...
                            for (var p = 0; p < pf.files.Count; p++)
                            {
                                ...
                                if (pf.files[p].filename  == "aw13.pmd"||pf.files[p].filename  == "bw11.pmd"||pf.files[p].filename.Contains("stage"))
                                {
                    ...
                    if (stagePath == "STAGE6")
                    {
                        levelName = "TESTLEVEL_1";
                    }
                    if (stagePath == "STAGE7")
                    {
                        levelName = "ANOTHER TESTLEVEL_1";
                    }
                    if (stagePath == "STAGE8")
                    {
                        levelName = "HollyWood hardjump";
                    }
                    if (stagePath == "STAGE9")
                    {
                        levelName = "Ice Canyon";
                    }
                    if (stagePath == "STAGE10")
                    {
                        levelName = "Cathederal";
                    }
                    ...
                    {
                        levelName = "TESTLEVEL_2";
                    }
                    if (stagePath == "STAGE13")
                    {
                        levelName = "ANOTHER TESTLEVEL_2";
                    }
                    if (stagePath == "STAGE14")
                    {
                        levelName = "Chemical Factory";
                    }
                    if (stagePath == "STAGE15")
                    {
                        levelName = "Glass Towers";
                    }
                    if (stagePath == "STAGE16")
                    {
                        levelName = "Villa Cuba";
                    }
                    ...
                    if (stagePath == "STAGE22")
                    {
                        levelName = "Chicks";
                    }
                    if (stagePath == "STAGE23")
                    {
                        levelName = "Coins";
                    }
                    ...
                    plyExportFolder = plyDumpFolder + "\\" + levelName +"\\";
